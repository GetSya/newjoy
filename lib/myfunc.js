...
exports.totalcase = () => {
   var file = fs.readFileSync("../sya.js").toString()
...
exports.otpkode = (length) => {
    let result = '';
    const characters = '1234567890ABCDEFGHIJKLMNOPQRSTUVQXYZ';
...
exports.smsg = (client, m, store) => {
    ...
    if (m.message) {
        ...
        if (m.quoted) {
            ...
            try{
                const mention = m.msg.message[m.msg.type].contextInfo.mentionedJid
                m.msg.mentioned = mention
            }catch{
                m.msg.mentioned = []
            }
